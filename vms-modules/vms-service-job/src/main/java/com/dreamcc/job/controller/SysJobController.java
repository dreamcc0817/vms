package com.dreamcc.job.controller;

import com.dreamcc.common.core.constant.Constants;
import com.dreamcc.common.core.exception.job.TaskException;
...
import com.dreamcc.job.domain.SysJob;
import com.dreamcc.job.service.ISysJobService;
import com.dreamcc.job.util.CronUtils;
...
public class SysJobController extends BaseController
{
    ...
    public AjaxResult add(@RequestBody SysJob job) throws SchedulerException, TaskException
    {
        ...
        else if (StringUtils.containsAny(job.getInvokeTarget(), new String[] { Constants.HTTP, Constants.HTTPS }))
        {
            return error("新增任务'" + job.getJobName() + "'失败，目标字符串不允许'http(s)//'调用");
        }
        else if (StringUtils.containsAny(job.getInvokeTarget(), Constants.JOB_ERROR_STR))
        {
